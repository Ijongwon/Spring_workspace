...
//	private static final Logger logger = LoggerFactory.getLogger(ProductApp.class);
	...
	public static void main(String[] args) {
		...
		= new AnnotationConfigApplicationContext(MyProductConfig.class);
		
		MyProductDao dao = context.getBean(MyProductDao.class);
		dao.product();
		System.out.println("\n");
		MyProductService service = context.getBean(MyProductService.class);
		service.product();
